...
AppId={{DD0F1B46-75C9-4672-AFD4-3985863526E7}
AppName={#MyAppName}
...
[Files]
Source: "C:\Users\numer\source\repos\CBriscola.WPF\CBriscola.WPF\bin\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\numer\source\repos\CBriscola.WPF\CBriscola.WPF\bin\Release\net7.0-windows10.0.22621.0\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Registry]
Root: HKCU; Subkey: "SOFTWARE\CBriscola"; Permissions: users-modify; Flags: uninsdeletekey; 
